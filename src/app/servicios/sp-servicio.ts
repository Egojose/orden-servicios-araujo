    ...
    public ObtenerConfiguracionConPost() {
        const configuracionSharepoint = sp.configure({
            headers: {
                'Accept': 'application/json; odata=verbose',
                'Content-Type': 'application/json;odata=verbose',
                'Authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiIsIng1dCI6ImllX3FXQ1hoWHh0MXpJRXN1NGM3YWNRVkduNCIsImtpZCI6ImllX3FXQ1hoWHh0MXpJRXN1NGM3YWNRVkduNCJ9..3rMlZouWhYRRjWH1Jr2myBmWzbGJtTlYj-Tu2ndwdwyMvpoZllMm9C24ST9heUP5zWWyhgIiMuGOCi_ZL-vnxt0uYlfYZ0ISWMMtXiJfe9YYYzjGTJoZN_u4y0PyksY2fH6pTlG4HCQmphCpZtLwISWfTuAPRjWG0VJ-Tyjilq4ZPRPobcrLcYxujoeOyzRnpOf2E2aB7jfp3v-PML8vKl3Xv9oE9BqhFjC6oBjsEGGHAQJxr3s-1KqsqBREPteAxXMThfawEsNOgf8eGWuHset04y3yUHidd6JgSV-Qzv_R2f0ARssHYfqyV6FHTKAQmW4FigeqNHLwqeGmVToeVg'
            }
        }, environment.urlWeb);
